...
- **Aula:** Projeto Andróid
- **Exemplo Prático X:** Este exercício serve de exemplo de um site completo chamado Projeto Andróid.
...
1. Clone este repositório em sua máquina local:
   ...
   ```bash
   git clone https://github.com/MarcusFerreira/projeto-android.git
